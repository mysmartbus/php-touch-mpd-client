...
class HtmlForm {
    ...
    public function format_fieldid($id) {
        /**
        ...
        **/
        ...
        // Remove everything except a-z, A-Z, 0-9, and the underscore character
	...
	public function start_form($formaction='', $frmname='', $method='') {
        /**
	...
	public function start_form_upload($formaction='', $frmname='', $method='') {
        /**
 ...
 *
 * 2018-01-15:
 *      -Changed visibility of function format_fieldid() from private to public
 *
 * 2017-07-28:
