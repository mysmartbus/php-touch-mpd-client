...
function displayCoverArt($album, $artist = '', $fb = 'front') {
    ...
    **/
    ...
    global $dbc, $origartist, $origalbum;
    ...
    if ($album != '' && $artist != '') {
        ...
        echo json_encode(array('coverart' => 'http://www.kraven.rat/files/'.substr($filehash,0,1).'/'.substr($filehash,0,2).'/'.$filename));
        exit;
 ...
 *
 * 2017-08-23:
 *      -Added more debug output to the "return lyrics" path
 *      -Album ID no longer missing when calling get_lyrics()
 *
 * 2017-06-02:
 *      -Added check for NULL values in function displayCoverArt()
 *
 * 2017-05-21:
 *      -Added return= option 'coverart'
 *      -Added function displayCoverArt()
**/
?>
